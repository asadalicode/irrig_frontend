!(function (c, M) {
  ...
  function p(c) {
    ...
    return (
      ...
      A(n),
      b(n, p.length),
      { name: M[0], abbrs: o(M[1].split(' '), p), offsets: o(z, p), untils: n, population: 0 | M[5] }
    );
  }
  function n(c) {
    c && this._set(p(c));
  ...
  function T(c) {
    return (
      T.didShowError ||
        ((T.didShowError = !0),
        u("moment.tz.zoneExists('" + c + "') has been deprecated in favor of !moment.tz.zone('" + c + "')")),
      !!f(c)
    );
  }
  function l(c) {
  ...
  var C,
    ...
    g = +D[1];
  (P < 2 || (2 === P && g < 6)) &&
    u('Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js ' + c.version + '. See momentjs.com'),
    (n.prototype = {
      _set: function (c) {
        (this.name = c.name),
          (this.abbrs = c.abbrs),
  ...
  (c.tz = t),
    ...
    (c.updateOffset = function (M, z) {
      var A,
        b = c.defaultZone;
      void 0 === M._z &&
        (b && l(M) && !M._isUTC && ((M._d = c.utc(M._a)._d), M.utc().add(b.parse(M), 'minutes')), (M._z = b)),
        M._z &&
          ((A = M._z.utcOffset(M)),
          Math.abs(A) < 16 && (A /= 60),
