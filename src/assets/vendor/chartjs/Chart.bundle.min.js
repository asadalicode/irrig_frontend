            ...
            (a = function () {
              ...
              function m(t) {
                if (null == t._isValid) {
                  ...
                  if (
                    (t._strict &&
                      (a = a && 0 === e.charsLeftOver && 0 === e.unusedTokens.length && void 0 === e.bigHour),
              ...
              function Wt(t, e) {
                ...
                return (
                  (i = Math.min(t.date(), At(t.year(), e))), t._d['set' + (t._isUTC ? 'UTC' : '') + 'Month'](e, i), t
                );
              }
              function Yt(t) {
              ...
              function Et(t, e, i, n, a) {
                ...
                return (
                  s <= 0 ? (o = St((r = t - 1)) + s) : s > St(t) ? ((r = t + 1), (o = s - St(t))) : ((r = t), (o = s)),
                  { year: r, dayOfYear: o }
                );
              }
              function jt(t, e, i) {
                      ...
                      t._w &&
                        ...
                        (function (t) {
                          ...
                          n < 1 || n > Ut(i, r, o)
                            ...
                            : ((s = Et(i, n, a, r, o)), (t._a[pt] = s.year), (t._dayOfYear = s.dayOfYear));
                        })(t),
                      null != t._dayOfYear &&
                        ((o = fe(t._a[pt], n[pt])),
                              ...
                              null === (h = xe.exec(n._i))
                                ? (_e(n),
                                  !1 === n._isValid &&
                                    (delete n._isValid,
                                    Se(n),
                                    !1 === n._isValid && (delete n._isValid, a.createFromInputFallback(n))))
                                : (n._d = new Date(+h[1])))
                            : r(i)
                    ...
                    : 'object' == typeof r &&
                      ...
                      ((a = (function (t, e) {
                        ...
                        (e = He(e, t)),
                          t.isBefore(e)
                            ? (i = Ge(t, e))
                            : (((i = Ge(e, t)).milliseconds = -i.milliseconds), (i.months = -i.months));
                        return i;
                      })(Te(r.from), Te(r.to))),
                      ((r = {}).ms = a.milliseconds),
                      (r.M = a.months)),
              ...
              (di.add = Je),
                ...
                (di.local = function (t) {
                  return (
                    this._isUTC && (this.utcOffset(0, t), (this._isUTC = !1), t && this.subtract(Ve(this), 'm')), this
                  );
                }),
              ...
              (ci.calendar = function (t, e, i) {
                ...
                ue('en', {
                  ...
                  ordinal: function (t) {
                    var e = t % 10;
                    return (
                      t + (1 === w((t % 100) / 10) ? 'th' : 1 === e ? 'st' : 2 === e ? 'nd' : 3 === e ? 'rd' : 'th')
                    );
                  },
                }),
              ...
              return (
                ...
                (Ei.as = function (t) {
                  ...
                  if ('month' === (t = L(t)) || 'year' === t)
                    return (e = this._days + n / 864e5), (i = this._months + bi(e)), 'month' === t ? i : i / 12;
                ...
                (a.updateLocale = function (t, e) {
                  if (null != e) {
                    ...
                    null != re[t] &&
                      (null != re[t].parentLocale ? (re[t] = re[t].parentLocale) : null != re[t] && delete re[t]);
                  return re[t];
                }),
                (a.locales = function () {
                  return C(re);
              ...
              (t.controllers.bar = t.DatasetController.extend({
                ...
                setHoverStyle: function (t) {
                  ...
                  (a.backgroundColor = n.hoverBackgroundColor
                    ...
                    : r.valueAtIndexOrDefault(e.hoverBackgroundColor, i, r.getHoverColor(a.backgroundColor))),
                    (a.borderColor = n.hoverBorderColor
                      ? n.hoverBorderColor
                      : r.valueAtIndexOrDefault(e.hoverBorderColor, i, r.getHoverColor(a.borderColor))),
              ...
              t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  ...
                  this.removeHoverStyle(t),
                    (i && l.animateRotate) ||
                      ((y.startAngle = 0 === e ? s.rotation : n.getMeta().data[e - 1]._model.endAngle),
            ...
            (e.exports = function (t) {
              ...
              t.controllers.line = t.DatasetController.extend({
                ...
                setHoverStyle: function (t) {
                  ...
                  (a.radius =
                    n.hoverRadius ||
                    r.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius)),
                    (a.backgroundColor =
                      n.hoverBackgroundColor ||
                      r.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, r.getHoverColor(a.backgroundColor))),
                    (a.borderColor =
                      n.hoverBorderColor ||
                      r.valueAtIndexOrDefault(e.pointHoverBorderColor, i, r.getHoverColor(a.borderColor))),
                    (a.borderWidth =
                      n.hoverBorderWidth || r.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth));
                },
                removeHoverStyle: function (t) {
                  var e = this,
                  ...
                  void 0 !== i.radius && void 0 === i.pointRadius && (i.pointRadius = i.radius),
                    (o.radius =
                      a.radius || r.valueAtIndexOrDefault(i.pointRadius, n, e.chart.options.elements.point.radius)),
                    ...
                    for (var e, i, n = this.animations, a = 0; a < n.length; )
                      (i = (e = n[a]).chart),
                        ...
                        e.currentStep >= e.numSteps
                          ? (r.callback(e.onAnimationComplete, [e], i), (i.animating = !1), n.splice(a, 1))
                          : ++a;
                  },
                }),
              ...
              a.extend(t.prototype, {
                ...
                buildOrUpdateScales: function () {
                  ...
                  n.scales &&
                    ...
                    n.scale &&
                      o.push({ options: n.scale, dtype: 'radialLinear', isDefault: !0, dposition: 'chartArea' }),
                    a.each(o, function (n) {
                      var o = n.options,
                        l = o.id,
                  ...
                  return (
                    a.each(
                      ...
                      function (a, r) {
                        ...
                        if (
                          (o.type && o.type !== s && (e.destroyDatasetMeta(r), (o = e.getDatasetMeta(r))),
                          (o.type = s),
                          i.push(o.type),
                          o.controller)
                        )
                ...
                update: function (e) {
                  ...
                  if (
                    ...
                    a.each(
                      ...
                      r._bufferedRender
                        ? (r._bufferedRequest = { duration: e.duration, easing: e.easing, lazy: e.lazy })
                        : r.render(e);
                  }
                },
                      ...
                      (r.almostEquals(n.deltaK, 0, this.EPSILON)
                        ...
                        : ((o = n.mK / n.deltaK),
                          ...
                          (u = Math.pow(o, 2) + Math.pow(s, 2)) <= 9 ||
                            ((l = 3 / Math.sqrt(u)), (n.mK = o * l * n.deltaK), (a.mK = s * l * n.deltaK))));
                for (e = 0; e < c; ++e)
                  (n = h[e]).model.skip ||
                    ((i = e > 0 ? h[e - 1] : null),
                    (a = e < c - 1 ? h[e + 1] : null),
                    ...
                    l.maxTicksLimit && (a = l.maxTicksLimit),
                      s &&
                        ...
                        (c + l.autoSkipPadding) * u > o.width - (o.paddingLeft + o.paddingRight) &&
                          (e =
                            1 +
                            Math.floor(((c + l.autoSkipPadding) * u) / (o.width - (o.paddingLeft + o.paddingRight)))),
                    ...
                    if (
                      ...
                      r.each(D, function (t) {
                        if (
                          ...
                          if (r.isArray(i))
                            for (
                              var n = i.length, a = 1.5 * y.size, o = e.isHorizontal() ? 0 : (-a * (n - 1)) / 2, l = 0;
                              l < n;
                              ++l
                            )
                ...
                for (
                  ...
                  (e = u[t]),
                    ...
                    0 === t
                      ...
                      : ((i = -1 === h ? i : u[h]),
                        n.skip ||
                          ((h !== t - 1 && !l) || -1 === h ? s.moveTo(n.x, n.y) : r.canvas.lineTo(s, i._view, e._view),
                          (h = t)));
                s.stroke(), s.restore();
              },
            }));
            ...
            (e.exports = a.extend({
              ...
              getCenterPoint: function () {
                var t,
                  ...
                  i = this._view;
                return (
                  r(this) ? ((t = i.x), (e = (i.y + i.base) / 2)) : ((t = (i.x + i.base) / 2), (e = i.y)),
                  { x: t, y: e }
                );
              },
              getArea: function () {
              ...
              if (e.display) {
                ...
                r.each(t.legendItems, function (n, l) {
                  ...
                  x
                    ...
                    : D + _ > t.bottom &&
                      ((S = d.x = S + t.columnWidths[d.line] + i.padding), (D = d.y = t.top + i.padding), d.line++),
                    (function (t, i, n) {
                      if (!(isNaN(y) || y <= 0)) {
                        h.save(),
          ...
          e.exports = {
            ...
            beforeUpdate: function (t) {
              var e = t.options.legend,
                i = t.legend;
              e
                ? (r.mergeIf(e, n.global.legend), i ? (o.configure(t, i, e), (i.options = e)) : d(t, e))
          ...
          e.exports = {
            ...
            beforeUpdate: function (t) {
              var e = t.options.title,
                i = t.titleBlock;
              e
                ? (r.mergeIf(e, n.global.title), i ? (o.configure(t, i, e), (i.options = e)) : u(t, e))
          ...
          e.exports = function (t) {
            var e = t.Scale.extend({
              ...
              getValueForPixel: function (t) {
                ...
                return (
                  (t -= n ? this.left : this.top), e && (t -= a / 2), (t <= 0 ? 0 : Math.round(t / a)) + this.minIndex
                );
              },
              getBasePixel: function () {
                return this.bottom;
              ...
              i = t.Scale.extend({
                ...
                getPixelForValue: function (e) {
                  ...
                  return (
                    ...
                    e !== r &&
                      (0 === r &&
                        ((i -= c = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize)),
                        (r = h)),
                  ...
                  ? (function (t) {
                      ...
                      for (e = 0; e < m; e++) {
                        (n = t.getPointPosition(e, u)),
                          ...
                          (g = t.pointLabels[e] || ''),
                          (i = a.isArray(g)
                            ? { w: a.longestText(c, c.font, g), h: g.length * f + 1.5 * (g.length - 1) * f }
                  ...
                  a.each(t.ticks, function (i, s) {
                    if (s > 0 || r.reverse) {
                      ...
                      if (
                        ...
                        if (
                          ((d.font = m), d.save(), d.translate(t.xCenter, t.yCenter), d.rotate(h), r.showLabelBackdrop)
                        ) {
