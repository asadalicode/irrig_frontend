            ...
            var b = this || Function('return this')(),
              e = (function () {
                ...
                function i(a, b, c, d, e, f, g) {
                  ...
                  for (h in b)
                    b.hasOwnProperty(h) &&
                      ((i = g[h]), (k = 'function' == typeof i ? i : o[i]), (b[h] = j(c[h], d[h], k, l)));
                  return b;
                }
                function j(a, b, c, d) {
                  return a + (b - a) * c(d);
            ...
            !(function () {
              ...
              (function () {
                ...
                (e.setBezierFunction = function (a, c, d, f, g) {
                  var h = b(c, d, f, g);
                  return (
                    (h.displayName = a), (h.x1 = c), (h.y1 = d), (h.x2 = f), (h.y2 = g), (e.prototype.formula[a] = h)
                  );
                }),
              ...
              (function (a) {
                ...
                var u = /(\d|\-|\.)/,
                  ...
                  w = /[0-9.\-]+/g,
                  x = new RegExp(
                    'rgb\\(' + w.source + /,\s*/.source + w.source + /,\s*/.source + w.source + '\\)',
                    'g'
                  ),
                  y = /^.*\(/,
                  z = /#([0-9]|[a-f]){3,6}/gi,
        ...
        function (a, b, c) {
          var d = a('shifty'),
            ...
            g = function a(b, c) {
              ...
              c = e.extend({ duration: 800, easing: 'linear', from: {}, to: {}, step: function () {} }, c);
              var d;
