...
var JQVMap = function (a) {
  ...
  if (!d)
    throw new Error(
      'Invalid "' + a.map + '" map parameter. Please make sure you have loaded this map file in your HTML.'
    );
  ...
  if (
    (jQuery(a.container).delegate('svg' === this.canvas.mode ? 'path' : 'shape', 'mouseover mouseout', function (b) {
      var e = b.target,
  ...
  if (
    ...
    a.pins && ((b = { pins: a.pins, mode: a.pinMode }), (this.pinHandlers = !1), this.placePins(a.pins, a.pinMode)),
    a.showLabels)
  ) {
    this.pinHandlers = !1;
    var h = {};
...
(JQVMap.prototype = {
  ...
  (ColorScale.rgbToArray = function (a) {
    return (
      (a = a.substr(1)), [parseInt(a.substr(0, 2), 16), parseInt(a.substr(2, 2), 16), parseInt(a.substr(4, 2), 16)]
    );
  }),
      ...
      'content' === b
        ? jQuery.each(a, function (a, b) {
            if (0 !== jQuery('#' + c.getCountryId(a)).length) {
              ...
              e.length > 0 && e.remove(),
                c.container.append(
                  '<div id="' + d + '" for="' + a + '" class="jqvmap-pin" style="position:absolute">' + b + '</div>'
                );
            }
          })
        : jQuery.each(a, function (a, b) {
            if (0 !== jQuery('#' + c.getCountryId(a)).length) {
              ...
              e.length > 0 && e.remove(),
                c.container.append(
                  '<div id="' + d + '" for="' + a + '" class="jqvmap-pin" style="position:absolute"></div>'
                ),
                e.append(jQuery('#' + b));
            }
          }),
  ...
  (JQVMap.prototype.select = function (a, b) {
    (a = a.toLowerCase()),
      ...
      this.isSelected(a) ||
        ...
        this.selectedColor && b && ((b.currentFillColor = this.selectedColor), b.setFill(this.selectedColor)));
  }),
